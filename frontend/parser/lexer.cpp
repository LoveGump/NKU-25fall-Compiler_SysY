...
static const flex_int16_t yy_base[148] = {0,
    0,
    0,
    192,
    482,
...
static const flex_int16_t yy_def[148] = {0,
    140,
    1,
    140,
    140,
...
static const flex_int16_t yy_nxt[535] = {0,
    4,
    5,
    6,
    7,
...
static const flex_int16_t yy_chk[535] = {0,
    1,
    1,
    1,
    1,
...
#line 705 "frontend/parser/lexer.cpp"
#line 706 "frontend/parser/lexer.cpp"
...
#line 913 "frontend/parser/lexer.cpp"
...
#line 140 "frontend/parser/lexer.l"
                    {
                        float fval = convertToFloatDec(yytext);
                        return YaccParser::make_FLOAT_CONST(fval, loc);
                    }
...
#line 163 "frontend/parser/lexer.l"
                    {
                        try
                        {
                            float fval = convertToFloatHex(yytext);
...
#line 205 "frontend/parser/lexer.l"
                    {
...
#line 220 "frontend/parser/lexer.l"
                        {RETT(LPAREN, loc)} YY_BREAK case 56 : YY_RULE_SETUP
#line 221 "frontend/parser/lexer.l"
                                                               {RETT(RPAREN, loc)} YY_BREAK case 57
                        : YY_RULE_SETUP
#line 222 "frontend/parser/lexer.l"
                          {RETT(LBRACKET, loc)} YY_BREAK case 58 : YY_RULE_SETUP
#line 223 "frontend/parser/lexer.l"
                                                                   {RETT(RBRACKET, loc)} YY_BREAK case 59
                        : YY_RULE_SETUP
#line 224 "frontend/parser/lexer.l"
                          {RETT(LBRACE, loc)} YY_BREAK case 60 : YY_RULE_SETUP
...
#line 229 "frontend/parser/lexer.l"
                    ECHO;
                    YY_BREAK
#line 1387 "frontend/parser/lexer.cpp"
