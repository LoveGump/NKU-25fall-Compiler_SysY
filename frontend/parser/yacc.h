...
#pragma GCC message "bison: do not #define YYSTYPE in C++, use %define api.value.type"
        ...
        struct token
        {
            enum token_kind_type
            {
                ...
                TOKEN_END           = 283,  // END
                TOKEN_LL_CONST      = 284,  // LL_CONST
                TOKEN_DEFAULT       = 285,  // DEFAULT
                TOKEN_COLON         = 286,  // COLON
                TOKEN_INT           = 287,  // INT
                TOKEN_FLOAT         = 288,  // FLOAT
                TOKEN_VOID          = 289,  // VOID
                TOKEN_MULTI_COMMENT = 290,  // MULTI_COMMENT
                TOKEN_FLOAT_CONST   = 291,  // FLOAT_CONST
                TOKEN_PLUS          = 292,  // PLUS
                ...
                TOKEN_INC           = 306,  // INC
                TOKEN_DEC           = 307,  // DEC
                TOKEN_ASSIGN        = 308,  // ASSIGN
                TOKEN_PLUS_ASSIGN   = 309,  // PLUS_ASSIGN
                TOKEN_MINUS_ASSIGN  = 310,  // MINUS_ASSIGN
                TOKEN_MUL_ASSIGN    = 311,  // MUL_ASSIGN
                TOKEN_DIV_ASSIGN    = 312,  // DIV_ASSIGN
                TOKEN_MOD_ASSIGN    = 313,  // MOD_ASSIGN
                TOKEN_THEN          = 314   // THEN
            };
        ...
        struct symbol_kind
        {
            enum symbol_kind_type
            {
                ...
                S_RBRACE                = 27,  // RBRACE
                S_END                   = 28,  // END
                S_LL_CONST              = 29,  // LL_CONST
                S_DEFAULT               = 30,  // DEFAULT
                S_COLON                 = 31,  // COLON
                S_INT                   = 32,  // INT
                S_FLOAT                 = 33,  // FLOAT
                S_VOID                  = 34,  // VOID
                S_MULTI_COMMENT         = 35,  // MULTI_COMMENT
                S_FLOAT_CONST           = 36,  // FLOAT_CONST
                S_PLUS                  = 37,  // PLUS
                S_MINUS                 = 38,  // MINUS
                S_STAR                  = 39,  // STAR
                S_DIV                   = 40,  // DIV
                ...
                S_DEC                   = 52,  // DEC
                S_ASSIGN                = 53,  // ASSIGN
                S_PLUS_ASSIGN           = 54,  // PLUS_ASSIGN
                S_MINUS_ASSIGN          = 55,  // MINUS_ASSIGN
                S_MUL_ASSIGN            = 56,  // MUL_ASSIGN
                S_DIV_ASSIGN            = 57,  // DIV_ASSIGN
                S_MOD_ASSIGN            = 58,  // MOD_ASSIGN
                S_THEN                  = 59,  // THEN
                S_YYACCEPT              = 60,  // $accept
                S_PROGRAM               = 61,  // PROGRAM
                S_STMT_LIST             = 62,  // STMT_LIST
                S_STMT                  = 63,  // STMT
                S_CONTINUE_STMT         = 64,  // CONTINUE_STMT
                S_EXPR_STMT             = 65,  // EXPR_STMT
                S_VAR_DECLARATION       = 66,  // VAR_DECLARATION
                S_VAR_DECL_STMT         = 67,  // VAR_DECL_STMT
                S_FUNC_BODY             = 68,  // FUNC_BODY
                S_FUNC_DECL_STMT        = 69,  // FUNC_DECL_STMT
                S_FOR_STMT              = 70,  // FOR_STMT
                S_IF_STMT               = 71,  // IF_STMT
                S_PARAM_DECLARATOR_LIST = 72,  // PARAM_DECLARATOR_LIST
                S_VAR_DECLARATOR        = 73,  // VAR_DECLARATOR
                S_VAR_DECLARATOR_LIST   = 74,  // VAR_DECLARATOR_LIST
                S_ASSIGN_EXPR           = 75,  // ASSIGN_EXPR
                S_EXPR                  = 76,  // EXPR
                S_NOCOMMA_EXPR          = 77,  // NOCOMMA_EXPR
                S_LOGICAL_OR_EXPR       = 78,  // LOGICAL_OR_EXPR
                S_TYPE                  = 79   // TYPE
            };
        };
        ...
        struct symbol_type : basic_symbol<by_kind>
        {
...
#endif
            {
                ...
                YY_ASSERT(tok == token::TOKEN_YYEOF || (token::TOKEN_YYerror <= tok && tok <= token::TOKEN_YYUNDEF) ||
                          (token::TOKEN_IF <= tok && tok <= token::TOKEN_END) ||
                          (token::TOKEN_DEFAULT <= tok && tok <= token::TOKEN_VOID) ||
                          (token::TOKEN_PLUS <= tok && tok <= token::TOKEN_THEN));
#endif
            }
#if 201103L <= YY_CPLUSPLUS
...
#if !defined _MSC_VER || defined __clang__
                YY_ASSERT(
                    (token::TOKEN_STR_CONST <= tok && tok <= token::TOKEN_IDENT) || tok == token::TOKEN_MULTI_COMMENT);
#endif
            }
        };
...
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_DEFAULT(location_type l) { return symbol_type(token::TOKEN_DEFAULT, std::move(l)); }
#else
        static symbol_type make_DEFAULT(const location_type& l) { return symbol_type(token::TOKEN_DEFAULT, l); }
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_COLON(location_type l) { return symbol_type(token::TOKEN_COLON, std::move(l)); }
#else
        static symbol_type make_COLON(const location_type& l) { return symbol_type(token::TOKEN_COLON, l); }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_MULTI_COMMENT(std::string v, location_type l)
        {
            return symbol_type(token::TOKEN_MULTI_COMMENT, std::move(v), std::move(l));
        }
#else
        static symbol_type make_MULTI_COMMENT(const std::string& v, const location_type& l)
        {
...
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_NE(location_type l) { return symbol_type(token::TOKEN_NE, std::move(l)); }
#else
        static symbol_type make_NE(const location_type& l) { return symbol_type(token::TOKEN_NE, l); }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_PLUS_ASSIGN(location_type l)
        {
            return symbol_type(token::TOKEN_PLUS_ASSIGN, std::move(l));
        }
#else
        static symbol_type make_PLUS_ASSIGN(const location_type& l) { return symbol_type(token::TOKEN_PLUS_ASSIGN, l); }
#endif
#if 201103L <= YY_CPLUSPLUS
        static symbol_type make_MINUS_ASSIGN(location_type l)
        {
            return symbol_type(token::TOKEN_MINUS_ASSIGN, std::move(l));
        }
#else
        static symbol_type make_MINUS_ASSIGN(const location_type& l)
        {
            return symbol_type(token::TOKEN_MINUS_ASSIGN, l);
        }
#endif
#if 201103L <= YY_CPLUSPLUS
...
#line 2819 "frontend/parser/yacc.h"
